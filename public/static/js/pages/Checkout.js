...
class Checkout extends Component {
    render() {
        return ( <
            ...
            h2 className = "display2-size display2-md-size fw-700 text-white mb-0 mt-0" > Checkout < span className = "fw-700 ls-3 text-grey-200 font-xsssss mt-2 d-block" > 4 PRODUCT FOUND < /span></h
            2 >
            <
            /div> <
            /div> <
            ...
            <
            p class = "mb-0 mont-font font-xssss text-uppercase fw-600 text-grey-500" > < i class = "fa fa-exclamation-circle" > < /i> Have A Coupon? <a class="expand-btn text-grey-500 fw-700" href="/checkoutcoupon_info
            ...
            <
            a href = "/checkout"
            class = "w-100 p-3 mt-3 font-xsss text-center text-white bg-current rounded-3 text-uppercase fw-600 ls-3" > Place Order < /a>     <
            /div>
