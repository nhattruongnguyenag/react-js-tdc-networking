...
class Cart extends Component {
    render() {
        return ( <
            ...
            h2 className = "display2-size display2-md-size fw-700 text-white mb-0 mt-0" > Cart < span className = "fw-700 ls-3 text-grey-200 font-xsssss mt-2 d-block" > 4 PRODUCT FOUND < /span></h
            2 >
            <
            /div> <
            /div> <
            ...
            tr >
            <
            th className = "border-0 p-4" > & nbsp; < /th> <
            ...
            <
            img src = "assets/images/p-1-1.jpg"
            ...
            <
            a href = "/cart"
            className = "text-grey-900 fw-600 font-xsss" > Super skinny blazer < /a> <
            /h3> <
            /td> <
            ...
            td className = "product-thumbnail text-left ps-0" >
            <
            img src = "assets/images/p-4-1.jpg"
            alt = "Product Thumnail"
            className = "w75 rounded-3" / >
            <
            /td> <
            ...
            <
            a href = "/cart"
            className = "text-grey-900 fw-600 font-xsss" > Jogging trousers < /a> <
            /h3> <
            /td> <
            td className = "product-p" >
            <
            ...
            td className = "product-thumbnail text-left ps-0" >
            <
            img src = "assets/images/p-3-1.jpg"
            alt = "Product Thumnail"
            className = "w75 rounded-3" / >
            <
            /td> <
            ...
            <
            a href = "/cart"
            className = "text-grey-900 fw-600 font-xsss" > Grey blue leather backpack < /a> <
            /h3> <
            /td> <
            td className = "product-p" >
            <
            ...
            <
            a href = "/cart"
            className = "bg-dark text-white fw-600 text-uppercase font-xssss border-dark border rounded-3 border-size-md d-inline-block w175 p-3 text-center ls-3" > Apply Coupon < /a> <
            /div> <
            a href = "/cart"
            className = "update-cart bg-dark float-right text-white fw-600 text-uppercase font-xssss border-dark border rounded-3 border-size-md d-inline-block w175 p-3 text-center ls-3" > Update Cart < /a> <
            /div> <
            ...
            /div> <
            a href = "/cart"
            className = "bg-dark float-right text-white fw-600 text-uppercase font-xsss border-dark border rounded-3 border-size-md d-inline-block w-100 p-3 text-center ls-3" > Proceed To Checkout < /a> <
            /div> <
            /div>
