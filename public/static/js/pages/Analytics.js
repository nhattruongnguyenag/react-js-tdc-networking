...
class Analytics extends Component {
    ...
    render() {
        return ( <
            ...
            h4 className = "text-primary font-xl fw-700" > 2.3 M < span className = "fw-500 mt-0 d-block text-grey-500 font-xssss" > day visiter < /span></h
            4 >
            <
            /div> <
            /div> <
            ...
            h4 className = "text-secondary font-xl fw-700" > 44.6 K < span className = "fw-500 mt-0 d-block text-grey-500 font-xssss" > total user < /span></h
            4 >
            <
            /div> <
            /div> <
            ...
            h4 className = "text-success font-xl fw-700" > 603 < span className = "fw-500 mt-0 d-block text-grey-500 font-xssss" > monthly sale < /span></h
            4 >
            <
            /div> <
            /div> <
            ...
            h4 className = "text-warning font-xl fw-700" > 3 M < span className = "fw-500 mt-0 d-block text-grey-500 font-xssss" > day visiter < /span></h
            4 >
            <
            /div> <
            /div> <
