...
class Payment extends Component {
    render() {
        return ( <
            ...
            className = "d-inline-block mt-2" > < i className = "ti-arrow-left font-sm text-white" > < /i></Link >
            <
            ...
            <
            h4 className = "text-grey-900 font-sm fw-700 mont-font mb-3 text-dark-color" > $ 5960.00 < span className = "d-block fw-500 text-grey-500 font-xssss mt-1 text-dark-color" > Debit Card < /span></h
            4 >
            <
            /div> <
            /div> <
            ...
            div className = "col-6" >
            <
            img src = "assets/images/b-14.png"
            alt = "icon"
            ...
            <
            h4 className = "text-white font-sm fw-700 mont-font mb-3" > $ 5960.00 < span className = "d-block fw-500 text-white font-xssss mt-1" > Debit Card < /span></h
            4 >
            <
            /div> <
            /div> <
            ...
            div className = "card bg-transparent border-0 bg-transparent-card shadow-none p-0 text-left w-100 mt-auto" >
            <
            h4 className = "text-white mb-3 font-sm fw-700 mont-font" > $ 2260.00 < span className = "d-block fw-500 text-grey-300 font-xssss mt-1" > Debit Card < /span></h
            4 >
            <
            /div> <
            /div> <
            ...
            <
            a href = "/payment"
            className = "rounded-xxl border-dashed mb-2 p-3 w-100 fw-600 fw-700 text-center font-xssss mont-font text-uppercase ls-3 text-grey-900 d-block  text-dark" > Add Card < /a>
            ...
            <
            img src = "assets/images/b-17.png"
            alt = "icon"
            ...
            <
            h4 className = "text-grey-900 font-sm fw-700 mont-font text-dark-color" > ** ** ** ** ** ** 2234 < span className = "d-block fw-500 text-grey-500 font-xssss mt-0 mb-3 text-dark-color" > Credit Card < /span></h
            4 >
            <
            /div> <
            /div> <
            ...
            <
            a href = "/payment"
            className = "rounded-3 bg-current mb-2 mt-4 p-3 w-100 fw-600 fw-700 text-center font-xssss mont-font text-uppercase ls-3 text-white d-block" > Add Card < /a> <
            /div> <
            /div> <
            /form> <
            /div>        <
