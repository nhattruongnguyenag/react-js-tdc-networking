...
class Singleproduct extends Component {
    render() {
        ...
        return ( <
            ...
            <
            img src = "assets/images/pl6.png"
            alt = "product"
            className = "mb-2 w-100 bg-white p-3" / >
            <
            img src = "assets/images/pl7.png"
            alt = "product"
            className = "mb-2 w-100 bg-white p-3" / >
            <
            img src = "assets/images/pl8.png"
            alt = "product"
            className = "mb-2 w-100 bg-white p-3" / >
            <
            img src = "assets/images/pl9.png"
            alt = "product"
            className = "mb-2 w-100 bg-white p-3" / >
            <
            /div> <
            ...
            className = "add-to-cart bg-dark text-white fw-700 ps-lg-5 pe-lg-5 text-uppercase font-xssss float-left border-dark border rounded-3 border-size-md d-inline-block mt-0 p-3 text-center ls-3" > Add to cart < /a> <
            a href = "/defaulthoteldetails"
            className = "btn-round-xl alert-dark text-white d-inline-block mt-0 ms-4 float-left" > < i className = "ti-heart font-sm" > < /i></a >
            <
            /div>   <
            /form> <
            div className = "clearfix" > < /div> <
