...
class Emailopen extends Component {
    render() {
        return ( <
            ...
            <
            div className = "middle-sidebar-left pe-0 ps-lg-3 ms-0 me-0"
            style = {
                {
                    maxWidth: `100%`
                }
            ...
            <
            h6 className = "fw-600 text-grey-500 font-xsssss" > Today, 16 th September 2020, 11: 45 < /h6> <
            h2 className = "font-sm text-grey-900 fw-600" > Meeting World < /h2> <
            /div> <
            /div>

            <
            Accordion className = "accodion-style--1 accordion"
            preExpanded = {
                '0'
            } >
            <
            ...
            <
            figure class = "avatar me-2 mb-0 w35 mt-1 pt-1" > < img src = "assets/images/user-8.png"
            alt = "avater"
            class = "float-right shadow-sm rounded-circle w-100" / > < /figure> <
            ...
            textarea class = "form-control mb-5 p-3 h100 bg-greylight lh-16"
            rows = "5"
            ...
            AccordionItemButton className = "d-flex" >
            <
            figure class = "avatar me-2 mb-0 w35 mt-1 pt-1" > < img src = "assets/images/icon2.png"
            alt = "avater"
            class = "float-right shadow-none rounded-circle w-75" / > < /figure> <
            span class = "font-xssss text-grey-700 pt-2 mt-1 ps-2 fw-700 mb-0 me-auto text-dark" > Aenni Mirenda < /span> <
            span class = "font-xssss text-grey-500 pt-2 mt-1 ps-2 fw-600 mb-0 ms-auto" > 14.09 .2020 12: 23 < /span> <
            /AccordionItemButton> <
            /AccordionItemHeading> <
            ...
            <
            div className = "chat-bottom dark-bg p-3 mb-3 border-top border-bottom bor-0 theme-dark-bg"
            style = {
                {
                    width: '98%'
                }
