        ...
        return ( <
            ...
            /div> {
                contactList.map((value, index) => (
                    ...
                    <
                    figure className = "avatar me-2 mb-0" > < img src = {
                    ...
                    mutual friends < /span></h
                    4 >
                    <
                    a href = "/defaultmember"
                    className = "btn-round-sm bg-white ms-auto mt-2" > < span className = "feather-chevron-right font-xss text-grey-900" > < /span></a >
                    <
                    /div>
