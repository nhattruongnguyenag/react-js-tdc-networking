...
function CustomizeBodyBusinessProfile(props: Readonly<BusinessProfileType>) {
    return (
        <div className='containerBodyProfile'>
            ...
            <div className='lineOfInfoBodyProfile'>
                <div>
                    <FontAwesomeIcon icon={faClock} size='xl' color={COLOR_GREY} className='icon-arrow-left' />
                </div>
                <div className='txtInfoBodyProfile text-grey-900 text-dark'>{props.t("Profile.profileOperatingHours")}: {props.timeWork}</div>
            </div>
            <div className='lineOfInfoBodyProfile'>
                <div>
                    <FontAwesomeIcon icon={faMoneyCheck} size='xl' color={COLOR_GREY} className='icon-arrow-left' />
                </div>
                <div className='txtInfoBodyProfile text-grey-900 text-dark'>{props.t("Profile.profileTaxID")}: {props.TaxIdentificationNumber}</div>
            </div>
            <div className='lineOfInfoBodyProfile'>
                <div>
                    <FontAwesomeIcon icon={faUserTie} size='xl' color={COLOR_GREY} className='icon-arrow-left' />
                </div>
                <div className='txtInfoBodyProfile text-grey-900 text-dark'>{props.t("Profile.profileRepresentative")}: {props.representative}</div>
            </div>
            <div className='lineOfInfoBodyProfile'>
                <div>
                    <FontAwesomeIcon icon={faMapLocationDot} size='xl' color={COLOR_GREY} className='icon-arrow-left' />
                </div>
                <div className='txtInfoBodyProfile text-grey-900 text-dark'>{props.t("Profile.profileAddress")}: {props.address}</div>
            </div>
            <div className='lineOfInfoBodyProfile'>
                <div>
