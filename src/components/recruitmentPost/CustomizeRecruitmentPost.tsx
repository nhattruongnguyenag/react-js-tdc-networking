...
import { faMapLocation, faClock, faMoneyCheckDollar, faBriefcase, faAnglesRight } from '@fortawesome/free-solid-svg-icons'
            ...
            <div className='col-md-11'>
                <div className='wrapper-infor-job'>
                    ...
                    <div className='list-infor-about-recruitment'>
                        <div className='icon-item-infor-job-recruitment'><FontAwesomeIcon icon={faClock} size='1x' color={COLOR_GREY} /><p className='txt-item-recruitment'>{props.createdAt}</p></div>
                        <div className='icon-item-infor-job-recruitment'><FontAwesomeIcon icon={faMoneyCheckDollar} size='1x' color={COLOR_GREY} /><p className='txt-item-recruitment'>{formatVietNamCurrency(props.salary)} vnd</p></div>
                        <div className='icon-item-infor-job-recruitment'><FontAwesomeIcon icon={faBriefcase} size='1x' color={COLOR_GREY} /><p className='txt-item-recruitment'>{props.employmentType}</p></div>
                    </div>
                    <div className='pt-2'>
                        <button
