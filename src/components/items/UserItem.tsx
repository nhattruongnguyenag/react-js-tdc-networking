...
export default function UserItem(props: UserItemProps) {
    ...
    return (
        <div className='card shadow-xs mb-2 border-0 bg-white p-4' style={{ flexDirection: 'row', height: 90, alignItems: 'center' }}>
            <img style={{ width: 65, height: 65, marginLeft: 30, marginRight: 20, borderRadius: 50, borderWidth: 1, borderColor: 'primary', backgroundSize: 'cover' }} src={SERVER_ADDRESS + 'api/images/' + item.image} />
