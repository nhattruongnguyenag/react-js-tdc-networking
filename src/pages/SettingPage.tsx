...
import { APPROVAL_POST_PAGE, LIST_JOB_APPLY_PAGE, LOGIN_PAGE, MANAGEMENT_JOB_APPLY_PAGE, PENDING_POST_PAGE, USER_DETAILS_PAGE } from '../constants/Page'
                    ...
                    <div className='col-lg-12'>
                      ...
                      <ul className='list-inline mb-4'>
                        <li className='list-inline-item d-block border-bottom me-0'>
                          <a href="#" onClick={() => { handleClickToAvatarAndName() }} className='d-flex align-items-center pb-2 pt-2'>
